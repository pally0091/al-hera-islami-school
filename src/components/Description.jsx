const DescriptionSection = () => {
  return (
    <section>
      <h2 className="font-bold text-[#1E3A8A] mb-6">
      ...
      <p className="text-left leading-relaxed mt-4 max-w-4xl mx-auto">
        ...
        <ul className="list-disc list-inside text-left mx-auto max-w-4xl">
          <li>
            সাধারণ শিক্ষার পাশাপাশি ধর্মীয় শিক্ষা সমন্বিত একটি পূর্ণাঙ্গ
            পাঠ্যক্রম।
          </li>
          <li>
            নৈতিক ও আধ্যাত্মিক বিকাশে মনোনিবেশকৃত একটি সুরক্ষিত শিক্ষাবান্ধব
            পরিবেশ।
          </li>
          <li>
            অভিজ্ঞ এবং নিবেদিত শিক্ষকগণ, যারা শিক্ষার্থীদের শিক্ষাজীবনে
            দিকনির্দেশনা দেন।
          </li>
          <li>
            সহায়ক একটি সম্প্রদায় যেখানে শিক্ষার্থীরা শিখে, বেড়ে ওঠে এবং সফল
            হয়।
          </li>
        </ul>
      </p>
      ...
      <p className="mt-8 text-2xl font-semibold text-[#2D8C7C]">
